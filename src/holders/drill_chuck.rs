...
impl Identifiable for DrillChuck {
    fn get_id(&self) -> Uuid {
        self.id
    }
}

impl Locatable for DrillChuck {
    ...
    fn draw_adding_to_library(
        ...
        ui.horizontal(|ui| {
            ...
            if ui.button("Save").clicked() {
                ...
                library.holders.push(Holder::DrillChuck(self.clone()));
                *popup_state = PopupState::None;
            }
        });
    }
