...
impl Identifiable for ExternalTurning {
    fn get_id(&self) -> Uuid {
        self.id
    }
}

impl Locatable for ExternalTurning {
...
impl Drawable for ExternalTurning {
    ...
    fn draw_adding_to_library(
        ...
        ui.horizontal(|ui| {
            ...
            if ui.button("Save").clicked() {
                ...
                library.holders.push(Holder::ExternalTurning(self.clone()));
                *popup_state = PopupState::None;
            }
        });
    }
