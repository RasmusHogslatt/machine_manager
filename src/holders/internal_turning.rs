...
impl Identifiable for InternalTurning {
    fn get_id(&self) -> Uuid {
        self.id
    }
}

impl Locatable for InternalTurning {
...
impl Drawable for InternalTurning {
    ...
    fn draw_adding_to_library(
        ...
        ui.horizontal(|ui| {
            ...
            if ui.button("Save").clicked() {
                ...
                library.holders.push(Holder::InternalTurning(self.clone()));
                *popup_state = PopupState::None;
            }
        });
    }
