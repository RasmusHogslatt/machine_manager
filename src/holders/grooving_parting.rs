...
impl Identifiable for GroovingParting {
    fn get_id(&self) -> Uuid {
        self.id
    }
}

impl Locatable for GroovingParting {
...
impl Drawable for GroovingParting {
    ...
    fn draw_adding_to_library(
        ...
        ui.horizontal(|ui| {
            ...
            if ui.button("Save").clicked() {
                ...
                library.holders.push(Holder::GroovingParting(self.clone()));
                *popup_state = PopupState::None;
            }
        });
    }
